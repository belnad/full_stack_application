...
def hello_me():
    ...
    return ("""%s your email is %s and your user_id is %s!
               <ul>
                 <li><a href="/">Home</a></li>
                 <li><a href="//localhost:8080/realms/master/account?referrer=flask-app&referrer_uri=http://localhost:5000/private&">Account</a></li>
                </ul>""" %
...
def logout():
    ...
    session.clear()
    oidc.logout()
    requests.get("http://localhost:8080/realms/master/protocol/openid-connect/logout")
    return res
